const ContactForm = () => {
  return (
    <div className="bg-[#4F0072] text-white px-6 md:px-16 py-20">
      <div className="bg-[#6D1F8F66] p-10 md:p-16 rounded-2xl max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start">
        {/* Left Side */}
